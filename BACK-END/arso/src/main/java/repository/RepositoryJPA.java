...
public abstract class RepositoryJPA<T extends Identificable> implements RepositoryString<T> {
	...
	/*public String asignaID(T entity) throws RepositorioException {
		int num = this.getAll().size() + 1;
		entity.setId("ID" + num);
