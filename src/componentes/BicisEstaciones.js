                        ...
                        <tr key={bici._id}>
                            ...
                            <td>
                                <div className="button-container">
                                    {userRole === 'Gestor' && (
                                        <Button variant="danger" style={{ marginRight: '3%', borderRadius: '50%' }} title="Dar de Baja" onClick={() => handlePrevioBajaBici(bici.id)}>
                                            <BiSolidDislike />
                                        </Button>
                                    )}
                                    {bici.estado === 'DISPONIBLE' && (
                                        <>
                                            <Button className='custom-button' style={{ marginRight: '3%', borderRadius: '50%' }} title="Reservar" onClick={() => handleReservar(bici.id)}>
                                                <FaCalendarCheck />
                                            </Button>
